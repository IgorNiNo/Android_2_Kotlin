package ru.myproject.android_2_kotlin.view.googlemaps
...
import ru.myproject.android_2_kotlin.databinding.FragmentGoogleMapsMainBinding
...
class GoogleMapsFragment : Fragment() {
    ...
    private val callback = OnMapReadyCallback { googleMap ->
        map = googleMap
        val initialPlace = LatLng(56.2965039, 43.936059)
        googleMap.addMarker(
